...
public class NewspaperReports extends javax.swing.JFrame { 
    Statement st = null;
    ...
    public NewspaperReports() throws Exception { 
       
        Conn connections = new Conn();
        data = connections.getNewspaper();
    ...
    private void initComponents() {
        ...
        label1.setText("Newspaper Reports");
        getContentPane().add(label1);
        label1.setBounds(490, 50, 390, 60);

        jDateChooser1.setDateFormatString("MM-dd-yyyy");
        getContentPane().add(jDateChooser1);
        jDateChooser1.setBounds(300, 270, 280, 40);
        ...
        jButton1.setBounds(620, 270, 110, 40);
        ...
        jButton2.setBounds(790, 270, 110, 40);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      //  String dated = sd.format(jDateChooser1.getDate())+ "%"; 
       ...
       /* ResultSet rs = null;
        ...
        data = theSearch("Select * from tbl_librarynewspaper where DateAcquisition like '" + dated + "'");
        table_book.setModel(new javax.swing.table.DefaultTableModel(data, header));
        //table_book.removeColumn(table_book.getColumnModel().getColumn(0));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            String sql = "Select * from tbl_librarynewspaper where DateAcquisition like '" + dated + "'";
            Map param= new HashMap();
            JRDesignQuery newQuery = new JRDesignQuery();
            newQuery.setText(sql); 
            
            InputStream file = getClass().getResourceAsStream("/Reports/newspaper.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewspaperReports.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new NewspaperReports().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(NewspaperReports.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
  ...
  private Vector<Vector<String>> theSearch(String sqlSearch) {
        Vector<Vector<String>> useVectors = new Vector<Vector<String>>();
        Connection con = null;
        Statement st = null;
