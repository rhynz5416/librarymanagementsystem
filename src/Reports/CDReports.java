...
public class CDReports extends javax.swing.JFrame { 
    Statement st = null;
    ...
    public CDReports() throws Exception { 
       
        Conn connections = new Conn();
        data = connections.getCD();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      //  String dated = sd.format(jDateChooser1.getDate())+ "%"; 
       ...
       /* ResultSet rs = null;
        ...
        data = theSearch("Select * from tbl_cd where cd_DateAcquisition like '" + dated + "'");
        table_book.setModel(new javax.swing.table.DefaultTableModel(data, header));
        //table_book.removeColumn(table_book.getColumnModel().getColumn(0));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            String sql = "Select * from tbl_cd where cd_DateAcquisition like '" + dated + "'";
            Map param= new HashMap();
            JRDesignQuery newQuery = new JRDesignQuery();
            newQuery.setText(sql); 
            
            InputStream file = getClass().getResourceAsStream("/Reports/cd.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CDReports.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new CDReports().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(CDReports.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
