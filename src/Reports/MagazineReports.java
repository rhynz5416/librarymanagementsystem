...
public class MagazineReports extends javax.swing.JFrame { 
    Statement st = null;
    ...
    public MagazineReports() throws Exception { 
       
        Conn connections = new Conn();
        data = connections.getMagazine();
    ...
    private void initComponents() {
        ...
        label1.setText("Magazine Reports");
        getContentPane().add(label1);
        label1.setBounds(490, 50, 320, 60);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      //  String dated = sd.format(jDateChooser1.getDate())+ "%"; 
       ...
       /* ResultSet rs = null;
        ...
        data = theSearch("Select * from tbl_magazine where DateAcquisition like '" + dated + "'");
        table_book.setModel(new javax.swing.table.DefaultTableModel(data, header));
        //table_book.removeColumn(table_book.getColumnModel().getColumn(0));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            String sql = "Select * from tbl_magazine where DateAcquisition like '" + dated + "'";
            Map param= new HashMap();
            JRDesignQuery newQuery = new JRDesignQuery();
            newQuery.setText(sql); 
            
            InputStream file = getClass().getResourceAsStream("/Reports/magazine.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MagazineReports.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new MagazineReports().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(MagazineReports.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
