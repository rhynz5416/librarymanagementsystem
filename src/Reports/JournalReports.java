...
public class JournalReports extends javax.swing.JFrame { 
    Statement st = null;
    ...
    public JournalReports() throws Exception { 
       
        Conn connections = new Conn();
        data = connections.getJournal();
    ...
    private void initComponents() {
        ...
        label1.setText("Journal Reports");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      //  String dated = sd.format(jDateChooser1.getDate())+ "%"; 
       ...
       /* ResultSet rs = null;
        ...
        data = theSearch("Select * from tbl_journal where DateAcquisition like '" + dated + "'");
        table_book.setModel(new javax.swing.table.DefaultTableModel(data, header));
        //table_book.removeColumn(table_book.getColumnModel().getColumn(0));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            String sql = "Select * from tbl_journal where DateAcquisition like '" + dated + "'";
            Map param= new HashMap();
            JRDesignQuery newQuery = new JRDesignQuery();
            newQuery.setText(sql); 
            
            InputStream file = getClass().getResourceAsStream("/Reports/journal.jrxml");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JournalReports.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    new JournalReports().setVisible(true);
                } catch (Exception ex) {
                    Logger.getLogger(JournalReports.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
